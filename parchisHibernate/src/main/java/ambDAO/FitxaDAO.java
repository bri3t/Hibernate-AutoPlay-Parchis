...
public interface FitxaDAO {
	...
	void finalitzarRecorregut(Fitxa fitxa); // verifica si una fitxa ha completat el seu recorregut amb la quantitat exacta d'espais, moventla a la casella final
